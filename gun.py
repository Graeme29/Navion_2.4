class Pew:
    ...
    def checkForHit(self, thingToCheckAgainst):
        if thingToCheckAgainst.x < self.x < thingToCheckAgainst.x + thingToCheckAgainst.width:
            if thingToCheckAgainst.y < self.y < thingToCheckAgainst.y + thingToCheckAgainst.height:
                return True
